...
#ifndef SPONGE_STREAM_REASSEMBLER_HH
#define SPONGE_STREAM_REASSEMBLER_HH
...
private:
    ...
    std::vector<char> _unassembled_bytes;
    std::vector<bool> _accepted_bytes;
    bool eof_set = false;
    size_t end_index = 0;
    void assemble_data();
...
#endif //SPONGE_STREAM_REASSEMBLER_HH
